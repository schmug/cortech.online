...
// Module-level cache to prevent duplicate fetches when multiple instances of
// BlogApp are mounted simultaneously or it is repeatedly opened.
...
export default function BlogApp() {
  ...
  useEffect(() => {
    ...
    if (!fetchPromise) {
      // Security: use AbortSignal to prevent hangs
      fetchPromise = fetch('/api/blog.json', {
